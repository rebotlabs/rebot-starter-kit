          ...
          <CardFooter className="justify-end">
            <Dialog>
              ...
              <DialogContent>
                ...
                <DialogDescription>
                  Once you leave <strong>{organization.name}</strong>, you will lose access to all its resources and will need to be re-invited to
                  rejoin. Please enter your password to confirm you would like to leave this organization.
                </DialogDescription>
